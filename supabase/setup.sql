-- ───────────────────────────────────────────────────────────
-- Spicer OS — complete database setup. Paste this whole file into
-- your Supabase SQL editor and run it once. That's the whole step.
-- (Generated by publish-kit from schema.sql + migrations — do not
--  hand-edit; every statement is idempotent and safe to re-run.)
-- ───────────────────────────────────────────────────────────
...
-- ===== migrations/2026-05-26-t5-hygiene.sql =====
...
-- ===== migrations/2026-05-30-onboarding.sql =====
...
-- ===== migrations/2026-06-01-journal.sql =====
...
-- ===== migrations/2026-06-01-memory-kinds.sql =====
...
-- ===== migrations/2026-06-01-net-worth-snapshots.sql =====
...
-- ===== migrations/2026-06-01-time-blocks.sql =====
...
-- ===== migrations/2026-06-14-alfred-autonomy-cage.sql =====
...
-- ===== migrations/2026-06-14-alfred-capture-buffer.sql =====
...
-- ===== migrations/2026-06-14-alfred-people.sql =====
...
-- ===== migrations/2026-06-14-alfred-proposals.sql =====
...
-- ===== migrations/2026-06-14-alfred-tier3.sql =====
